    ...
    'metadata': {
        ...
        'backup_server': {
            ...
            'targets': {
                ...
                'nuke-k3s-dev-master-0.hm.benjamin-borbe.de': {},
                'nuke-k3s-dev-worker-0.hm.benjamin-borbe.de': {},
                ...
                'nuke-k3s-prod-master-0.hm.benjamin-borbe.de': {},
                'nuke-k3s-prod-worker-0.hm.benjamin-borbe.de': {},
                'nuke-k3s-prod.hm.benjamin-borbe.de': {},
